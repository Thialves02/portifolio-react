...
export default function Projeto() {
    const [projects] = useState([
        ...
        },
        {
            nome:'Projeto Deezer',
            cargo:'Desenvolvedor Front-end',
            descricao:'O projeto tem como objetivo simular o tocador de músicas "Deezer". O usuário pode ouvir, pesquisar e favoritar músicas. Para realizar o projeto durante o tempo determinado eu utilizei o Jira para gerenciar o tempo e as tarefas que deveriam ser feitas',
        ...
        },
        {
            nome:'Website',
            cargo:'Desenvolvedor Front-end',
            descricao:'Projeto feito a fim de reforçar o conhecimento em React e aprender sobre React Router Dom, além de aprender sobre inglês técnico através do tutorial.',
            tecnologias:'React e CSS',
            imagem:website,
            site:'',
        ...
        },
        {
            nome:'Recipe App',
            cargo:'Desenvolvedor Front-end',
            descricao:'Primeiro projeto feito em React consumindo uma API externa. O projeto consiste em um site de busca de receitas disponibilizadas pela API.',
            tecnologias:'React e CSS',
            imagem:recipe,
            site:'',
        ...
        },
        {
            nome:'Login Screen',
            cargo:'Desenvolvedor Front-end',
            descricao:'Projeto feito a fim de reforçar os conhecimentos de CSS e responsividade.',
